...
const Success = () =>{
    return (
        <>
        <div className='bg-success-600 w-4/5 max-w-md mx-auto flex justify-center items-center flex-col p-4 m-2 rounded' style={{backgroundColor: 'rgba(40, 167, 69, 0.5)'}}>
