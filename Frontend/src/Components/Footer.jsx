...
const Footer = () => {
  return (
    ...
    <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
            ...
            <div className="row">
              <div className="col-md-4 mb-5">
                ...
                <div className="d-flex flex-column justify-content-start">
                  ...
                  <Link className="text-secondary mb-2" to={'/detail'}><i className="fa fa-angle-right mr-2"></i>Shop Detail</Link>
      ...
      {/* <!-- Back to Top --> */}
      <Link href="#" className="btn btn-primary back-to-top"><i className="fa fa-angle-double-up"></i></Link>
